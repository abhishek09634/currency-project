...
async function pushCurrencyDataFunc() {
  ...
  console.log(CURRENT_DATE_TIME.toLocaleString()+ ' : '+USD + ' : ' + EUR + ' : ' + GBP + ' : ' + CNY);
  ...
  let db = new sqlite3.Database(DBSOURCE, (err) => {
    if (err) {
      ...
      db.serialize(function () {
        ...
        db.run('INSERT INTO currency_rates (timestamp, usd, eur, gbp, cny) VALUES (?,?,?,?,?)', [CURRENT_DATE_TIME, USD, EUR, GBP, CNY]);
      });
